...
function renderResults(container, state) {
	...
	if (percentage >= 100) {
		achievement = { emoji: '🥇', title: 'Gold Master', message: 'Perfect score! You\'re amazing!' };
	} else if (percentage >= 75) {
		achievement = { emoji: '🥈', title: 'Silver Expert', message: 'Great job! You know your stuff!' };
	} else if (percentage >= 50) {
		achievement = { emoji: '🥉', title: 'Bronze Scholar', message: 'Good effort! Keep learning!' };
	} else {
		achievement = { emoji: '📚', title: 'Knowledge Seeker', message: 'Keep practicing!' };
	}
